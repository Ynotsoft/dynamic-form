...
const MenuBar = ({ editor, error }) => {
	...
	const btnClass = (active) =>
		`p-2 rounded-sm transition-colors duration-200 focus-visible:ring-1 focus-visible:ring-ring/40 focus-visible:outline-none ${
			active
	...
	return (
		<div
			className={`flex flex-wrap gap-1 p-1.5 border-b bg-muted/30 rounded-t-lg transition-colors ${
	...
	return (
		...
		>
			...
			>
				...
				<div
					className={`flex justify-end px-4 py-2  text-[10px] uppercase tracking-wider ${
						error
